      ...
      <form>
        <div className='bg-white p-4 md:w-3/4 md:m-auto rounded-lg shadow-lg'>
          ...
          <fieldset className="fieldset">
            ...
            <input type="text" name='ref-memo' className="input w-full focus:outline-none" placeholder="Memo Number" />
          </fieldset>
          <fieldset className="fieldset">
            <legend className="fieldset-legend text-lg font-thin">Payment Metohd</legend>
            <input type="text" name='payment-method' className="input w-full focus:outline-none" placeholder="Payment Method" />
          </fieldset>
          <fieldset className="fieldset">
