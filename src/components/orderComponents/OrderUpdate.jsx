...
function OrderUpdate({ order }) {
    ...
    const [deliveryStatus, setDeliveryStatus] = useState(order?.order_status || false)
    ...
    useEffect(() => {
        if (order) {
            setDeliveryStatus(order?.order_status || false)
        }
    }, [order])
    ...
    const handleFormSubmit = event => {
        ...
        orderFormData.append('order_status', deliveryStatus)
                    ...
                    <form onSubmit={handleFormSubmit}>
                        <div className='bg-white p-4 md:m-auto rounded-lg shadow-lg'>
                            ...
                            <fieldset className="fieldset">
                                ...
                                <input type="text" name='memo_number' readOnly className="input w-full focus:outline-none" defaultValue={order?.memo_number} />
                            </fieldset>
                            <fieldset className="fieldset">
                                <legend className="fieldset-legend text-lg font-thin">Product Title</legend>
                                <input type="text" name='product_title' className="input w-full focus:outline-none" defaultValue={order?.product_name} />
                            </fieldset>
                            <fieldset className="fieldset">
                                <legend className="fieldset-legend">Details</legend>
                                <textarea className="textarea h-24 w-full" name='details' defaultValue={order?.details}></textarea>
                            </fieldset>
                            <fieldset className="fieldset">
                            ...
                            <fieldset className="fieldset">
                                ...
                                <input type="number" name='total_price' className="input w-full focus:outline-none" defaultValue={order?.total_price} />
                            </fieldset>
                            <fieldset className="fieldset">
                                <legend className="fieldset-legend text-lg font-thin">Advance Payment</legend>
                                <input type="number" name='advance_payment' className="input w-full focus:outline-none" defaultValue={order?.advance_payment} />
                            </fieldset>
                            <fieldset className="fieldset">
                            ...
                            <fieldset className="fieldset">
                                ...
                                <input type="date" name='next_advance_payment_date' className="input w-full focus:outline-none" defaultValue={order?.next_advance_payment_date} />
                            </fieldset>
                            <fieldset className="fieldset">
